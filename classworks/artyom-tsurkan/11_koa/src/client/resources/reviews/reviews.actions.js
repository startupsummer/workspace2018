...
export function getReviews() {
    return async (dispatch) => {
        ...
        try {
            ...
            dispatch({ type: 'GET_REVIEWS_FAILURE', error: err.message });
        }
    };
}
...
export function createReview(values) {
    return async (dispatch) => {
        try {
            ...
            dispatch({ type: 'CREATE_REVIEW_FAILURE', error: err.message });
        }
    };
}
...
export function getReviewsCount() {
  return async (dispatch) => {
    ...
    try {
      ...
      dispatch({ type: 'GET_REVIEWS_COUNT_FAILURE', error: err.message });
    }
  };
}