  ...
  render() {
    ...
    const icon = this.props.filter === 'open' ?
      ...
      (<div className="issues__status issues__status--closed">
        <svg aria-hidden="true" className=" issues__icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"></path></svg>
      </div>);
