...
const favSvg = (
  <Svg styles={styles.favButton} viewBox="0 0 48 48" width={48} height={48}>
...
export default ({ item, isLast, onPressMakeFav }) => (
  <View style={[styles.card, isLast && styles.lastCard]}>
    ...
    <TouchableOpacity onPress={onPressMakeFav} style={styles.button}>
      {favSvg}
    </TouchableOpacity>
  </View>
)
