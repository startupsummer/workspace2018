...
export default ({ item, isLast, onPressMakeFav, index, isFav }) => (
  <View style={[styles.card, isLast && styles.lastCard]}>
    ...
    <TouchableOpacity onPress={onPressMakeFav(index)} style={styles.button}>
      {item.isFav ? favSvgActive : favSvg}
    </TouchableOpacity>
  </View>
)
