...
import * as pageheadActions from '../../resources/pagehead/pagehead.actions.js';
import * as pageheadSelectors from '../../resources/pagehead/pagehead.selectors.js';
      ...
      <div className="container">
        <nav className="reponav">
          <Link to='/list' className="reponav-item selected">
            ...
            <span>Issues</span>
            <span className="counter">{props.openIssuesCounter}</span>
          </Link>
        </nav>
      </div>
    </div>
...
const mapStateToProps = (state, props) => ({ openIssuesCounter: pageheadSelectors.selectOpenIssuesCounter(state) });
