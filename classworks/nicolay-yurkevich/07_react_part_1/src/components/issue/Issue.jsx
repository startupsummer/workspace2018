...
class Issue extends React.Component {
  ...
  const iconClass=cn({
    issue__status: true,
    'issue__status--open': this.props.state === 'open' ? true : false
  });
  return (
    <li className="issues__item">
    <div className={iconClass}>
       <svg className="issues__icon" fill="red" height="16" version="1.1" viewBox="0 0 16 16" width="16">
       <path fillRule="evenodd" d={this.state.svg}></path></svg>
    </div>
    ...
    <Btn text={this.state.text} type={this.props.state} onClick={this.props.toggleIssueState(this.props.id)}/>
    </li>
    );
  }
}
