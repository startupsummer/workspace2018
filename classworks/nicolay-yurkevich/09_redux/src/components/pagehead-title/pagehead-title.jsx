...
import './pagehead-title.css';

function PageheadTitle() {
  return (
    <h1 className="pagehead-title">
      ...
      <a href="https://github.com">startupsummer</a>
      <span>/</span>
      <b><a href="https://github.com/startupsummer/workspace2018/tree/master/lectures/07_react-part-1">react-task-1</a></b>
    </h1>
  );
}
