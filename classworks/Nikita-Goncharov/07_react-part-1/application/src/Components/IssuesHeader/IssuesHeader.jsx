    ...
    return (
      <div className="issues-listing__header">
        <div className="issues-listing__states">
          ...
          <Button ButtonClassName={"btn-link btn-link--selected"} buttonData={
            this.props.issuesData.filter((issue) => issue.state == "open").length+"Open"
          } onClick={this.props.showOpen} />
          ...
          <Button ButtonClassName={"btn-link"} buttonData={
            this.props.issuesData.filter((issue) => issue.state == "closed").length+"Closed"
          } onClick={this.props.showClose} />
        </div>
      </div>
    );
  }
