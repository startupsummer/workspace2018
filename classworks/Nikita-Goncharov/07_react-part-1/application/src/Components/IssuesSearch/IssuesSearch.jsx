    ...
    return (
      <div className="subnav">
        <form className="subnav__search">
          <input className="subnav__search-input" type="text" placeholder="Search"></input>
        ...
        <Button ButtonClassName={"btn btn-primary"} buttonData={"New issue"} onClick={this.props.newIssue} />
      </div>
    );
  }
}
