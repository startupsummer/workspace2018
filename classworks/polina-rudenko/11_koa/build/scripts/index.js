...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__styles_css__ = __webpack_require__(28);
...
__WEBPACK_IMPORTED_MODULE_1_axios___default.a.get('/counter').then(res => {
  document.querySelector('.counter').textContent = 'Number of sessions: ' + res.data;
});
...
const postData = event => {
  ...
  __WEBPACK_IMPORTED_MODULE_1_axios___default.a.post('/api/form-data', data).then(response => {
    console.log("super");
  });
};
