...
<div className="issues-listing__states">
  <button onClick={this.props.onClickOpen} className="btn-link btn-link--selected" type="button">
    ...
    {this.props.countOpen} Open
  </button>
  <button onClick={this.props.onClickClose} className="btn-link" type="button">
