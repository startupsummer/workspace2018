...
const Subnav = ({ searchIssues, addNewIssue }) => (
  <div className="subnav">
    <form className="subnav__search">
      <input className="subnav__search-input" type="text" placeholder="Search" onChange={searchIssues} />
    ...
    <Button type="primary" additionalClass="btn-primary" onClick={addNewIssue}>
      New
    </Button>
  </div>
);
