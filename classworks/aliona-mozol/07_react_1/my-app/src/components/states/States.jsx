  ...
  render() {
    return (
      <div className="states">
        <button className="btn-link btn-link--selected" type="button" onClick={this.props.onClickOpen}>
          ...
          {this.props.counterOpenIssues} Open
        </button>

        <button className="btn-link" type="button" onClick={this.props.onClickClosed}>
          ...
          {this.props.counterClosedIssues} Closed
        </button>
      </div>
    );
  }
