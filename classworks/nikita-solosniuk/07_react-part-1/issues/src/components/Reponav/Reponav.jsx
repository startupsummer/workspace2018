...
class Reponav extends React.Component {
  render() {
    return (
      <div className="container reponav__container">
        <nav className="reponav">
          <a href="https://lipsum.com" className="reponav__item selected">
            ...
            <span>Issues</span>
            <span className="reponav__counter">{this.props.issuesCount}</span>
          </a>
        </nav>
      </div>
    );
