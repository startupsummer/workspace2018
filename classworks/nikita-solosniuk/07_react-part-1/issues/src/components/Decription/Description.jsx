...
const Description = (props) => {
  const icoPath = props.issuesList.find(i => String(i.id) === props.id).state === 'open'
  ...
  return (
    <div className="full-description">
      <div className="description-title">
        ...
        {props.issuesList.find(i => String(i.id) === props.id).title}
      </div>
      <div className="description">
        {props.issuesList.find(i => String(i.id) === props.id).title} <b>is a real problem!</b>
      </div>
    </div>
  );
};
