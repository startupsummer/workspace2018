...
class IssueListingSubnav extends React.Component {
  createNewIssue = () => {
    this.props.newIssue({ title: Math.random(), state: 'open', id: Math.random() });
  }
    ...
    return (
      <div className="issues-listing__subnav">
        <div className="subnav">
          ...
          <button onClick={this.createNewIssue} className="btn btn-primary" type="button">
          New issue
          </button>
        </div>
      </div>
...
export default IssueListingSubnav;
