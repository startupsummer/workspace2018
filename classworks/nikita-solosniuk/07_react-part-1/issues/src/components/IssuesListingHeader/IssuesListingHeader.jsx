...
class IssuesListingHeader extends React.Component {
  render() {
    const openBtnClass = cn({
      'btn-link': true,
      'btn-link--selected': this.props.tabState === 'open',
    });

    const closedBtnClass = cn({
      'btn-link': true,
      'btn-link--selected': this.props.tabState === 'closed',
    });

    return (
      <div className="issues-listing__header">
        <div className="issues-listing__states">
          <button onClick={this.props.onOpenClick} className={openBtnClass} type="button">
            ...
            {this.props.tabState === 'open' ? this.props.issuesList.length : this.props.startList.length - this.props.issuesList.length} Open
          </button>

          <button onClick={this.props.onClosedClick} className={closedBtnClass} type="button">
            ...
            {this.props.tabState === 'closed' ? this.props.issuesList.length : this.props.startList.length - this.props.issuesList.length} Closed
          </button>
        </div>
      </div>
    );
