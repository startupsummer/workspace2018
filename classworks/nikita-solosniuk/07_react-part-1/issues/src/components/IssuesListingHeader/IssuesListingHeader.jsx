    ...
    <div className="issues-listing__header">
      <div className="issues-listing__states">
        <button onClick={props.onOpenClick} className={openBtnClass} type="button">
          ...
          {props.tabState === 'open' ? props.issuesList.length : props.startList.length - props.issuesList.length} Open
        </button>
        ...
        <button onClick={props.onClosedClick} className={closedBtnClass} type="button">
          ...
          {props.tabState === 'closed' ? props.issuesList.length : props.startList.length - props.issuesList.length} Closed
        </button>
      </div>
    </div>
  );
