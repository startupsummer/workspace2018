	...
	return(
		<div className="issues-listing__header">
			<div className="issues-listing__states">
				<button onClick={props.onTabClick('open')} className="btn-link btn-link--selected" type="button">
				...
				<button
					onClick={props.onTabClick('closed')}
					className="btn-link"
					type="button"
				>
...
const mapDispatchToProps = (dispatch) => ({
	onTabClick: issueActions.onTabClick(dispatch),
});
