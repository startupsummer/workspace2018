...
function SubNavbar(props) {
  return (
    <div className="subnav">
      ...
      <Button text="New issue" onButtonClick={props.onAddIssue} />
    </div>
  );
}
...
SubNavbar.defaultProps = {
  searchValue: '',
  onSearchInput: () => console.log('onSearchInput does not work in SubNavbar component'),
  onAddIssue: () => console.log('onAddIssue does not work in SubNavbar component'),
};
