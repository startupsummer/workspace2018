...
function SubNavbar(props) {
  ...
  const createIssue = () => {
    props.createIssue(generateService.generateIssue());
  };
  ...
  return (
    <div className="subnav">
      ...
      <Button isPrimary onButtonClick={createIssue}>
        New issue
      </Button>
    </div>
  );
...
const mapStateToProps = state => ({
  searchValue: IssuesSelectors.getSearchValue(state),
});

const mapDispatchToProps = {
  createIssue: IssuesActions.createIssue,
  setSearchValue: IssuesActions.setSearchValue,
};
