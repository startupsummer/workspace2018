...
import './RepositoryNavbar.css';

function RepositoryNavbar(props) {
  return (
...
RepositoryNavbar.propTypes = {
  notificationsAmount: PropTypes.number.isRequired,
};

const mapStateToProps = state => ({
  notificationsAmount: IssuesSelectors.getOpenIssuesAmount(state),
});

export default connect(mapStateToProps)(RepositoryNavbar);
